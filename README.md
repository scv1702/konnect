...
2. 코로나19로 인해 대학생활이 줄어들면서 새로운 친구를 만날 수 없다는 것이 주요한 문제점이었는데, 멘토멘티 시스템을 통해 팀을 배정받음으로써 이러한 문제점을 해결할 수 있다. 팀원들끼리의 친목을 도모할 수 있을 것이며 이 과정에서 의사소통을 하기 때문에 소통 능력이 향상된다.
